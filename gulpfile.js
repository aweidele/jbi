...
var jsQueue = ["node_modules/owl.carousel/dist/owl.carousel.min.js", "src/js/*.js"];
...
gulp.task("compress", function () {
  return gulp.src(jsQueue).pipe(concat("scripts.js")).pipe(gulp.dest("assets/js")).pipe(rename("site.js")).pipe(uglify()).pipe(gulp.dest("assets/js"));
});
